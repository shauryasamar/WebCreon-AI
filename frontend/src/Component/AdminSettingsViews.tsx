...
// ==========================================
export const AdminDomainSettings: React.FC<{ siteId?: string }> = ({ siteId }) => {
  const { hasPermission, isOwner } = useAdminAuth();
  const canView = isOwner || hasPermission("domain_settings:view");
  const canEdit = isOwner || hasPermission("domain_settings:edit");

  const [subdomain] = useState("mybrandstore");
  const [customDomain, setCustomDomain] = useState("www.mybrandstore.in");
  ...
  if (!canView) {
    return (
      <AccessDeniedView
        title="Domain Settings Restricted"
        message="You do not have permission to manage custom domains and URLs."
        requiredPermission="domain_settings:view"
      />
    );
  }
  ...
  return (
    <div style={{ padding: "24px 28px", maxWidth: "900px", margin: "0 auto", color: "#0f172a" }}>
      ...
      <div style={{ marginBottom: "24px" }}>
        ...
        <p style={{ margin: 0, fontSize: "13px", color: "#64748b" }}>
          Connect your custom domain name, manage DNS settings, and monitor SSL certificates.
        </p>
      </div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
        ...
        <div style={{ background: "#ffffff", borderRadius: "14px", border: "1px solid #e2e8f0", padding: "20px 24px", boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "12px" }}>
            <div>
              <div style={{ fontSize: "11px", fontWeight: 700, color: "#2563eb", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: "4px" }}>
                WebCreon Free Subdomain
              </div>
              <div style={{ fontSize: "15px", fontWeight: 600, color: "#0f172a" }}>
                https://{subdomain}.webcreon.ai
              </div>
              <div style={{ fontSize: "12px", color: "#64748b", marginTop: "2px" }}>
                Always active as fallback routing for your storefront.
              </div>
            </div>
            <div style={{ display: "flex", gap: "8px" }}>
              <button
                type="button"
                onClick={() => {
                  navigator.clipboard.writeText(`https://${subdomain}.webcreon.ai`);
                  setToast({ message: "Store URL copied to clipboard!", type: "info" });
                }}
                style={{ padding: "8px 14px", borderRadius: "8px", border: "1px solid #cbd5e1", background: "#ffffff", color: "#334155", fontSize: "12px", fontWeight: 600, cursor: "pointer" }}
              >
                Copy URL
              </button>
              <a
                href={`https://${subdomain}.webcreon.ai`}
                target="_blank"
                rel="noreferrer"
                style={{ padding: "8px 14px", borderRadius: "8px", background: "#0f172a", color: "#ffffff", fontSize: "12px", fontWeight: 600, textDecoration: "none", display: "inline-flex", alignItems: "center" }}
              >
                Visit ↗
              </a>
            </div>
        ...
        <div style={{ background: "#ffffff", borderRadius: "14px", border: "1px solid #e2e8f0", padding: "20px 24px", boxShadow: "0 1px 3px rgba(0,0,0,0.04)" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "16px" }}>
            <h3 style={{ margin: 0, fontSize: "15px", fontWeight: 600, color: "#1e293b" }}>Connected Custom Domain</h3>
            {sslActive && (
              <span style={{ display: "inline-flex", alignItems: "center", gap: "6px", padding: "4px 10px", borderRadius: "20px", background: "#ecfdf5", color: "#059669", fontSize: "11px", fontWeight: 700, border: "1px solid #a7f3d0" }}>
          ...
          <div style={{ display: "flex", gap: "10px", marginBottom: "16px" }}>
            ...
            <button
              ...
              style={{ padding: "9px 18px", borderRadius: "8px", background: "#2563eb", color: "#ffffff", border: "none", fontSize: "12px", fontWeight: 600, cursor: !canEdit || verifying ? "not-allowed" : "pointer" }}
            >
          ...
          <div style={{ padding: "16px", borderRadius: "10px", background: "#f8fafc", border: "1px solid #e2e8f0" }}>
            <div style={{ fontSize: "12px", fontWeight: 700, color: "#334155", marginBottom: "8px" }}>DNS Configuration Records</div>
            <div style={{ display: "grid", gridTemplateColumns: "80px 140px 1fr 80px", gap: "8px", fontSize: "12px", color: "#475569", paddingBottom: "6px", borderBottom: "1px solid #e2e8f0", fontWeight: 600 }}>
              <span>Type</span>
              <span>Host / Name</span>
              <span>Points To / Value</span>
              <span>TTL</span>
            </div>
            <div style={{ display: "grid", gridTemplateColumns: "80px 140px 1fr 80px", gap: "8px", fontSize: "12px", color: "#0f172a", paddingTop: "8px", fontFamily: "monospace" }}>
              <span>CNAME</span>
              <span>www</span>
              <span>cname.webcreon.ai</span>
              <span>3600</span>
            </div>
            <div style={{ display: "grid", gridTemplateColumns: "80px 140px 1fr 80px", gap: "8px", fontSize: "12px", color: "#0f172a", paddingTop: "8px", fontFamily: "monospace" }}>
              <span>A</span>
